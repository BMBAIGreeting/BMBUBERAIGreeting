...
window = tk.Tk()
window.title("Uber Talking Greeting App - BMB Business AI Engine 2.0")
...
profile_options = ["Truck Driver", "Nurse", "Tourist / Visitor", "Business Traveler", "Local Rider"]
...
# Output Display
output_label = tk.Label(window, text="", wraplength=750, justify="left")
